...
companyRouter
  .route("/")
  .post(uploadOptions.single('company_profile') ,validate(createCompanyValidator), CompanyController.createCompany);
  companyRouter.route("/:id").get( CompanyController.singleCompany);
  companyRouter.route("/:id").patch( uploadOptions.single('company_profile_update') ,validate(createCompanyValidator),CompanyController.updateCompany);
