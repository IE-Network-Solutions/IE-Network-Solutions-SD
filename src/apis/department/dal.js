...
class DepartmentDAL {
    ...
    static async getDepartment(data) {
        ...
        try {
            ...
            // Get Data
            const foundDepartment = await departmentRepository.findBy({ id: id });
    ...
    static async editDepartment(id, data) {
        try {
            ...
            const department = await departmentRepository.findOneBy({ id: idDepartment });
    ...
    static async deleteAllDepartments() {
        try {
            ...
            // Delete All Departments
            const deletedDepartments = await departmentRepository.delete(allDepartments);
