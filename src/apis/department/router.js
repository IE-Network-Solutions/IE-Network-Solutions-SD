...
router.route("/:id").get(authorize, uuidValidator, DepartmentController.getDepartment);

router
    .route("/")
    .post(authorize, validate(departmentValidator), DepartmentController.createDepartment);

router
    .route("/")
    .patch(authorize, DepartmentController.editDepartment);
